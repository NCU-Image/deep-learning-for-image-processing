...
def main():
    ...
    # data_root = "C:\\project\\fly_net\\original"
    data_root = "/Users/william/Documents/数据集/wbblur"
    # origin_flower_path = os.path.join(data_root, "flower_photos")
    origin_flower_path = "/Users/william/Documents/数据集/wbblur"
    ...
    for cla in flower_class:
        ...
        test_index = random.sample(images, k=int(num * split_rate_test))
