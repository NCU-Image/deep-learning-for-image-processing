...
class DATA_LCNN():
    ...
    def generate_data(self):
        ...
        x_I1_test, x_I2_test, x_I3_test, x_I4_test, y_test = self.shuffe_data(x_I1_test, x_I2_test,
                                                                                         x_I3_test, x_I4_test,
                                                                                          y_test)
        ...
        x_I1_train, x_I2_train, x_I3_train, x_I4_train, y_train = self.shuffe_data(x_I1_train, x_I2_train,
        ...
        x_I1_valid, x_I2_valid, x_I3_valid, x_I4_valid, y_valid = self.shuffe_data(x_I1_valid, x_I2_valid,
    ...
    def shuffe_data(self, x_train_I1, x_train_I2, x_train_I3, x_train_I4, y_train):
        ...
        return temp_x_I1, temp_x_I2, temp_x_I3, temp_x_I4, temp_y

    def load_train(self):

        return self.x_I1_train, self.x_I2_train, self.x_I3_train, self.x_I4_train, self.y_train

    def load_test(self):
        return self.x_I1_test, self.x_I2_test, self.x_I3_test, self.x_I4_test, self.y_test

    def load_valid(self):
        return self.x_I1_valid, self.x_I2_valid, self.x_I3_valid, self.x_I4_valid, self.y_valid
