...
def first_lcnn_train(model_name,index):
    ...
    history = model.fit([x_I1_train, x_I2_train, x_I3_train, x_I4_train], y_train, epochs=Epochs,initial_epoch=init_Epoch, batch_size=batch_size,validation_data=([x_I1_valid,x_I2_valid,x_I3_valid,x_I4_valid],y_valid),validation_freq=1, callbacks=[csv_logger,cp_callback_save,cp_callback_save_best,learningSchudel])
