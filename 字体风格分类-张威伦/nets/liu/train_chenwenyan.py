...
from keras.layers import Input, Flatten, Dense, Lambda, Conv2D, MaxPooling2D, BatchNormalization, Activation, MaxPool2D, \
    Dropout
...
# network definition
base_network = nets.create_base_network(input_shape)
