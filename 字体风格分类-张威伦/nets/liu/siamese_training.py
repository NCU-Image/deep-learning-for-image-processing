...
class Generator:
    ...
    def _convert_path_list_to_images_and_labels(self, path_list):
        ...
        pairs_of_images = [np.zeros((number_of_pairs, self.image_height, self.image_width, self.channel)) for i in
                           range(2)]
    ...
    def generate(self, train=True):
        ...
        while 1:
            if train:
                ...
                self._current_train_alphabet_index = (self._current_train_alphabet_index + 1) // len(
                    self._train_alphabets)
            else:
                ...
                self._current_val_alphabet_index = (self._current_val_alphabet_index + 1) // len(
                    self._validation_alphabets)
