...
def fit_one_epoch(model_train, model, loss_history, optimizer, epoch, epoch_step, epoch_step_val, epoch_step_test
                  , gen, gen_val, gen_test, Epoch, cuda, save_period, save_dir):
    total_CE_loss = 0
    total_accuracy = 0
    ...
    model_train.train()
    for iteration, (images, labels) in enumerate(gen):
        ...
        pbar.set_postfix(**{'total_CE_loss': total_CE_loss / (iteration + 1),
