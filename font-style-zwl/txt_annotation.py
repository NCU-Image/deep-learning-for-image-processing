...
if __name__ == "__main__":
    ...
    #   训练集所在的路径
    # ---------------------#
    datasets_path = r"C:\project\lishu_cross\cross7\Train"
    # datasets_path   = r"C:\project\lishu_cross\cross7\Valid"
    # datasets_path   = r"C:\project\lishu_cross\cross0\Test"

    types_name = os.listdir(datasets_path)
    types_name = sorted(types_name)

    list_file = open('cls_train.txt', 'w')
    # list_file = open('cls_val.txt', 'w')
