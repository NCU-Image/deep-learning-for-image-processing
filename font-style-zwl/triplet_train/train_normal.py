...
from triplet_net.normal_net import NormalNet
from triplet_util.callback import LossHistory
from triplet_util.dataloader import TestDataSet
from triplet_util.utils import get_num_classes, show_config
from triplet_util.utils_fit_normal import fit_one_epoch
...
if __name__ == "__main__":
    ...
    #   载入模型并加载预训练权重
    # ---------------------------------#
    model = NormalNet(backbone=backbone, num_classes=num_classes, pretrained=pretrained)
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, Epoch):
            ...
            fit_one_epoch(model_train, model, loss_history, optimizer, epoch, epoch_step, epoch_step_val,
                          epoch_step_test, gen, gen_val, gen_test, Epoch, Cuda, save_period, save_dir)
